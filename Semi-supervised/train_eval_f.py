...
def cross_validation_with_val_set_f(dataset, args, logger):
    ...
    for fold, (train_idx, test_idx, val_idx) in enumerate(
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if epoch % args.lr_decay_step_size == 0: # lr_decay_step_size=500
    ...
    print('For suffix={}, model_epoch={}, Train Acc: {:.4f}, Test Acc: {:.4f} ± {:.4f}, Duration: {:.3f}'.
          format(args.suffix, args.model_epoch, train_acc_mean*100, test_acc_mean*100, test_acc_std*100, duration_mean))
    sys.stdout.flush()
