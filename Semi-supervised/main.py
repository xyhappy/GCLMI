...
if __name__ == '__main__':
    ...
    args.save_model = './{}/{}'.format('models', args.dataname)
    ...
    for suffix in [0, 1, 2, 3, 4]:
        ...
        for model_epoch in model_epochs:
            ...
            args.model_PATH = '{}/{}_lr={}_alpha={}_beta={}_epoch={}_suffix={}_model.pt'.format(args.save_model, args.dataname, args.lr, args.alpha, args.beta, args.model_epoch, args.suffix)
            _, acc, _, _ = cross_validation_with_val_set_f(dataset, args, logger=logger)
